...
public class libro {
	...
	public libro(int idLibro, String titulo, String editorial, int num_paginas, String edicion, String idioma,
			...
			String portada, String presentacion, float precio, int idCategoria, int idAutor) {
		super();
	...
	public String toString() {
		return "libro [idLibro=" + idLibro + ", titulo=" + titulo + ", editorial=" + editorial + ", num_paginas="
				+ num_paginas + ", edicion=" + edicion + ", idioma=" + idioma + ", descripcion=" + descripcion
				+ ", tipo_pasta=" + tipo_pasta + ", ISBN=" + ISBN + ", num_ejemplares=" + num_ejemplares + ", portada="
				+ portada + ", presentacion=" + presentacion + ", precio=" + precio + ", idCategoria=" + idCategoria
				+ ", idAutor=" + idAutor + "]";
	}
