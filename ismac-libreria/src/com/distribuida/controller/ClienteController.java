	...
	// JSP .- jAVA SERVER PAGE, SON LAS PAGINAS WEB DE TENCOLOGIA JAVA 
		...
		public String findAll(Model model ) {
			...
			//try {
				...
				return "listar-clientes"; //esto es el nombre del formulario ej "listar-clientes.html o " listar-clientes .jps"
	...
	//		}
		...
		public String add(@RequestParam("idCliente")@Nullable Integer idCliente
				...
				clienteDAO.add(cliente);
					...
					return "redirect:/cleintes/findAll"; // ir a formulario web por path o url.
